...
import nodemailer from 'nodemailer'
  ...
  await transporter.sendMail({
    ...
    to: email,
    subject: 'Novas Credencias BPA NET',
    text: ``,
    ...
    <p style="margin-bottom: 20px;">Abaixo estão os seus novos dados de acesso ao BPA NET</p>
 
    <p style="margin-top: 40px;"><strong>Novo Número de Adesão:  </strong>${numeroAdessao}</p>
